...
export enum StatementExportsApiApiKeys {
}

export class StatementExportsApi {
    ...
    public setApiKey(key: StatementExportsApiApiKeys, value: string) {
        (this.authentications as any)[StatementExportsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async exportStatement (merchantId: string, statementExportRequest: StatementExportRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(statementExportRequest, "StatementExportRequest")
        };
