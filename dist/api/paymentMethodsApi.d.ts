...
export declare enum PaymentMethodsApiApiKeys {
}
export declare class PaymentMethodsApi {
    ...
    setApiKey(key: PaymentMethodsApiApiKeys, value: string): void;
     ...
     */
    listPaymentMethods(merchantId: string, currency?: string, amount?: string, includeInactive?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
